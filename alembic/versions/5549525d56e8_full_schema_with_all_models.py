...
Revision ID: 5549525d56e8
Revises: 
Create Date: 2025-06-12 12:04:16.256965
...
def upgrade() -> None:
    ...
    sa.Column('platform', sa.Enum('WhatsApp', 'Discord', 'Telegram', name='platformenum'), nullable=True),
