...
Revision ID: abc0a0b36dbf
Revises: 
Create Date: 2025-07-07 17:08:04.665529
...
def upgrade() -> None:
    ...
    sa.Column('phase', sa.Enum('INTRO', 'DISCOVERY', 'CONFIRMATION', 'DELIVERY', 'FOLLOWUP', 'ENDING', name='phaseenum'), nullable=True),
    ...
    sa.Column('genre', sa.ARRAY(sa.String()), nullable=True),
    sa.Column('platform_preference', sa.ARRAY(sa.String()), nullable=True),
    sa.Column('last_recommended_game', sa.String(), nullable=True),
    sa.Column('rejected_games', sa.ARRAY(sa.String()), nullable=True),
    sa.Column('story_preference', sa.Boolean(), nullable=True),
    sa.Column('state', sa.Enum('ONBOARDING', 'ACTIVE', 'PASSIVE', 'COLD', 'CLOSED', name='sessiontypeenum'), nullable=True),
    sa.Column('intent_override_triggered', sa.Boolean(), nullable=True),
    sa.Column('followup_triggered', sa.Boolean(), nullable=True),
    sa.Column('game_rejection_count', sa.Integer(), nullable=True),
    sa.Column('shared_with_friend', sa.Boolean(), nullable=True),
    sa.Column('tone_shift_detected', sa.Boolean(), nullable=True),
    ...
    sa.Column('response_type', sa.Enum('GameRec', 'Intro', 'DiscoveryQ', 'Confirmation', 'Followup', 'RejectionAck', 'IdleChat', 'ReEntry', 'Callback', 'MoodlessFallback', 'IntentOverride', 'ExitMessage', 'ErrorRecovery', 'NotInTheMood', 'SharePrompt', name='responsetypeenum'), nullable=True),
    sa.Column('session_type', sa.Enum('ONBOARDING', 'ACTIVE', 'PASSIVE', 'COLD', 'CLOSED', name='sessiontypeenum'), nullable=True),
    sa.Column('game_id', sa.UUID(), nullable=True),
